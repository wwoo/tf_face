...
flags.DEFINE_string('gcs_export_uri', 'gs://wwoo-train/pubfig/export_cloudml/', 'Path to output files')
...
def main(argv=None):
    ...
    with tf.name_scope('serving'):
        ...
        softmax_pred = tf.nn.softmax(conv_net(image_batch, weights, biases, FLAGS.image_size, 1.0))
    ...
    with sess.as_default():
        ...
        try:
            ...
            if FLAGS.save_model:
                ...
                saver.save(sess, os.path.join(base_model_dir, 'export'))
